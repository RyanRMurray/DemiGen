...
--------------------------------------------------------------------------------------------------------
    ...
    testout = do
        ...
        let stream = convertRGB8 x
            ...
            (t1, c1) = generateFromImage stream 3 [noTransform] (getGrid 9 9) (mkStdGen 24201)
            (t2, c2) = generateFromImage stream 3 withReflections (getGrid 99 99) (mkStdGen 4201)
            (t3, c3) = generateFromImage dungeon 3 withReflectionsAndRotations (getGrid 100 100) (mkStdGen 3333)
